      ...
      {selectedRecord && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-slate-200/90 shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="md:w-3/5 bg-slate-950/90 border-r border-[#eaeff8] flex flex-col items-center justify-center p-6 min-h-[300px] relative">
            ...
            <div className="md:w-2/5 p-6 flex flex-col justify-between bg-white">
              <div>
                <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4">
                  <div>
                    <span className="text-[9px] font-bold px-2 py-0.5 bg-[#005BAA]/5 text-[#005BAA] border border-blue-105/50 rounded-md font-sans uppercase tracking-wider">
                      HỒ SƠ CHÍNH CHỦ
                    </span>
